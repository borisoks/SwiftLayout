...
//  SwiftLayout
//
//  Created by Boris Oks on 5/1/17.
...
extension UIView {
    ...
    struct Layout {
        ...
        // Pin Top
        @discardableResult func top(_ offset: CGFloat = 0, anchor: NSLayoutYAxisAnchor? = nil) -> Layout {
            self.constraints.top(offset, anchor: anchor)?.isActive = true
            return self
        }
        
        // Pin Right
        @discardableResult func right(_ offset: CGFloat = 0, anchor: NSLayoutXAxisAnchor? = nil) -> Layout {
            self.constraints.right(offset, anchor: anchor)?.isActive = true
            return self
        }
        
        // Pin Bottom
        @discardableResult func bottom(_ offset: CGFloat = 0, anchor: NSLayoutYAxisAnchor? = nil) -> Layout {
            self.constraints.bottom(offset, anchor: anchor)?.isActive = true
            return self
        }
        
        // Pin Left
        @discardableResult func left(_ offset: CGFloat = 0, anchor: NSLayoutXAxisAnchor? = nil) -> Layout {
            self.constraints.left(offset, anchor: anchor)?.isActive = true
            return self
        }
        
        // Center X
        @discardableResult func centerX(_ offset: CGFloat = 0) -> Layout {
            self.constraints.centerX(offset)?.isActive = true
            return self
        }
        
        // Center Y
        @discardableResult func centerY(_ offset: CGFloat = 0) -> Layout {
            self.constraints.centerY(offset)?.isActive = true
            return self
        }
        
        // Set Width
        @discardableResult func width(_ value: CGFloat, _ equality: Equality = .equalTo) -> Layout {
            self.constraints.width(value, equality)?.isActive = true
            return self
        }
        
        // Set Height
        @discardableResult func height(_ value: CGFloat, _ equality: Equality = .equalTo) -> Layout {
...
//        // Set Width
//        @discardableResult func setWidthConstraint(_ value: CGFloat) -> NSLayoutConstraint? {
//            return self.view.widthAnchor.constraint(equalToConstant: value)
//        }
//        
//        func setWidthConstraint(_ offset: CGFloat = 0, anchor: NSLayoutDimension? = nil, _ equality: Equality = .equalTo) -> NSLayoutConstraint? {
//            guard let otherAnchor = anchor else {
//                return nil
//            }
//            
//            if equality == .greaterThanOrEqualTo {
//                return self.view.widthAnchor.constraint(greaterThanOrEqualTo: otherAnchor, constant: offset)
//            } else if equality == .lessThanOrEqualTo {
//                return self.view.widthAnchor.constraint(lessThanOrEqualTo: otherAnchor, constant: offset)
//            } else {
//                return self.view.widthAnchor.constraint(equalTo: otherAnchor, constant: offset)
//            }
//        }
//        
//        @discardableResult func setWidth(_ value: CGFloat) -> Autolayout {
//            self.setWidthConstraint(value)?.isActive = true
//            return self
//        }
//        
//        @discardableResult func setWidth(_ offset: CGFloat = 0, anchor: NSLayoutDimension? = nil, _ equality: Equality = .equalTo) -> Autolayout {
//            self.setWidthConstraint(offset, anchor: anchor, equality)?.isActive = true
//            return self
//        }
//        
//        // Set Height
//        @discardableResult func setHeightConstraint(_ value: CGFloat, _ equality: Equality = .equalTo) -> NSLayoutConstraint? {
//            if equality == .greaterThanOrEqualTo {
//                return self.view.heightAnchor.constraint(greaterThanOrEqualToConstant: value)
//            } else if equality == .lessThanOrEqualTo {
//                return self.view.heightAnchor.constraint(lessThanOrEqualToConstant: value)
...
//        }
//        
//        func setHeightConstraint(_ offset: CGFloat = 0, anchor: NSLayoutDimension? = nil, _ equality: Equality = .equalTo) -> NSLayoutConstraint? {
//            guard let otherAnchor = anchor else {
//                return nil
//            }
//            
//            if equality == .greaterThanOrEqualTo {
//                return self.view.heightAnchor.constraint(greaterThanOrEqualTo: otherAnchor, constant: offset)
//            } else if equality == .lessThanOrEqualTo {
//                return self.view.heightAnchor.constraint(lessThanOrEqualTo: otherAnchor, constant: offset)
//            } else {
//                return self.view.heightAnchor.constraint(equalTo: otherAnchor, constant: offset)
//            }
//        }
//        
//        @discardableResult func setHeight(_ value: CGFloat, _ equality: Equality = .equalTo) -> Autolayout {
//            self.setHeightConstraint(value, equality)?.isActive = true
//            return self
//        }
//        
//        @discardableResult func setHeight(_ offset: CGFloat = 0, anchor: NSLayoutDimension? = nil, _ equality: Equality = .equalTo) -> Autolayout {
//            self.setHeightConstraint(offset, anchor: anchor, equality)?.isActive = true
//            return self
//        }
